...
pygame.display.set_caption('Letsgo')
clock = pygame.time.Clock()
test_font = pygame.font.Font("font/Pixeltype.ttf", 50)
score_rect = screen.get_rect(midbottom = (700,200))
game_active = False
start_time = 0
score = 0
highscore = 0
...
# text_surf = test_font.render("Wassup", False, 'orange')
...
game_name = test_font.render('The the the',False,(111,196,169))
...
while True:
    ...
    if game_active:
        ...
        if score > highscore:
            highscore = score
        high_score_message = test_font.render(f"High score: {highscore}",False,(111,196,169))
